...
from env.datatypes import State, Action, Observation
...
class ParkingRenderer:
    ...
    def draw_occupancy_grid(self, occupancy_grid: jnp.ndarray):
        ...
        # Resize to screen cell size
        surface = pygame.transform.scale(surface, (W * cell_size, H * cell_size))

        # Blit to screen centered at world (0, 0)
